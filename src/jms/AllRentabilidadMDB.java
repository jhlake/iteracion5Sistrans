...
public class AllRentabilidadMDB implements MessageListener, ExceptionListener 
{
	public final static int TIME_OUT = 5;
	private final static String APP = "app1";
	
	private final static String GLOBAL_TOPIC_NAME = "java:global/RMQTopicAllRentabilidad";
	...
	private List<ReporteRentabilidadC5> answer = new ArrayList<ReporteRentabilidadC5>();
	
	public AllRentabilidadMDB(TopicConnectionFactory factory, InitialContext ctx) throws JMSException, NamingException 
	{	
	...
	public ListaReporteRentabilidadC5 getRemoteReporteRentabilidadC5() throws JsonGenerationException, JsonMappingException, JMSException, IOException, NonReplyException, InterruptedException, NoSuchAlgorithmException
	{
		answer.clear();
		...
		ListaReporteRentabilidadC5 res = new ListaReporteRentabilidadC5(answer);
        return res;
	}
	...
	public void onMessage(Message message) 
	{
		...
		try 
		{
			...
			if(!ex.getSender().equals(APP))
			{
				...
				{
					ListaReporteRentabilidadC5 v = mapper.readValue(ex.getPayload(), ListaReporteRentabilidadC5.class);
